...
$info = [
    [
        'work_name' => 'REDBULL representative',
        'work_date' => 'Aug 2010 - May 2017',
        'work_descrip' => 'Energize people, creative work.',
    ],
    [
        'work_name' => 'Flight attendant',
        'work_date' => 'Sep 2015 - Dec 2020',
        'work_descrip' => 'safety on board, passenger service, first aid.',
    ],
    [
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        ...
        <div class="w3-container w3-card w3-white">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b>S7</b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Forever</h6>
            <p>Flight attendant!</p>
            <hr>
          </div>
          <div class="w3-container">
            <h5 class="w3-opacity"><b>Moscow Business School</b></h5>
